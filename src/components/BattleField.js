        ...
        if (Array.isArray(availableTargets) && availableTargets.length > 0 && availableAttackers.length > 0) {
            ...
            attackerTeam.forEach(attacker => {
                if (attacker.health > 0) {
                    let target = determineTarget({targetTeam, attackerTeam, availableTargets})
                    if (target !== undefined) {
            ...
            <div className="teams-wrapper">
                ...
                <div className="team-container">
                    ...
                    {enemyTeam.map(character => (
                        <RenderEnemyTeam character={character} selectedTarget={selectedTarget} handleSelectTargetButton={handleSelectTargetButton} />
                    ))}
                </div>
            </div>
